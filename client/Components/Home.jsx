import { fetchOrders, listProducts } from '@/lib/Utils/Panel';
...
const Home = () => {
  ...
  const order = async () => {
    ...
    const res2 = await listProducts();
    setOrderNumber(res.data.orders.length)
    setProductNumber(res2.data.data.length)
  }
  useEffect(() => {
    order()
  }, [])
